...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "RuleEngine", dependencies: ["FitnessDomain", "ExerciseCatalog", "Metrics"]),
        ...
        .testTarget(name: "RuleEngineTests", dependencies: ["RuleEngine", "ExerciseCatalog", "Metrics"]),
